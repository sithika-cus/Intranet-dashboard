<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li class="active">Foreign Training Programs</li>
  </ol>
</section>
...
<thead>
<tr>
    <th>Foreign Training Programs</th>
...
<tbody>
<?php foreach($foreign_transfer_files as $row): ?>
<tr>
    <td><?= esc($row['title']) ?></td>
    <td><?= esc($row['date']) ?></td>
    ...
    <button class="btn btn-xs btn-warning edit-ft-btn"
            data-id="<?= $row['id'] ?>"
    ...
    <button class="btn btn-xs btn-danger delete-ft-btn"
    data-id="<?= $row['id'] ?>">
...
<button class="btn btn-xs btn-success" data-toggle="modal" data-target="#addFtModal">
