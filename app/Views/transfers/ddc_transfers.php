<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li>Transfers</li>
    <li class="active">DDC Transfers</li>
  </ol>
</section>
...
<tbody>
<?php foreach($ddc_transfer_files as $row): ?>
<tr>
    <td><?= esc($row['title']) ?></td>
    <td><?= esc($row['date']) ?></td>
    ...
    <button class="btn btn-xs btn-warning edit-ddct-btn"
            data-id="<?= $row['id'] ?>"
    ...
    <button class="btn btn-xs btn-danger delete-ddct-btn"
    data-id="<?= $row['id'] ?>">
...
<button class="btn btn-xs btn-success" data-toggle="modal" data-target="#addDdctModal">
