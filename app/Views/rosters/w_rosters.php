<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li>Rosters</li>
    <li class="active">Warehouse Rosters</li>
  </ol>
</section>
...
<tbody>
<?php foreach($warehouse_roster_files as $row): ?>
<tr>
    <td><?= esc($row['title']) ?></td>
    <td><?= esc($row['date']) ?></td>
    ...
    <button class="btn btn-xs btn-warning edit-wr-btn"
            data-id="<?= $row['id'] ?>"
    ...
    <button class="btn btn-xs btn-danger delete-wr-btn"
    data-id="<?= $row['id'] ?>">
...
<button class="btn btn-xs btn-success" data-toggle="modal" data-target="#addWrModal">
