<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li>Rosters</li>
    <li class="active">Airport Rosters SC</li>
  </ol>
</section>
...
<tbody>
<?php foreach($airport_roster_files_sc as $row): ?>
<tr>
    <td><?= esc($row['title']) ?></td>
    <td><?= esc($row['date']) ?></td>
    ...
    <button class="btn btn-xs btn-warning edit-sc-btn"
            data-id="<?= $row['id'] ?>"
    ...
    <button class="btn btn-xs btn-danger delete-sc-btn"
    data-id="<?= $row['id'] ?>">
...
<button class="btn btn-xs btn-success" data-toggle="modal" data-target="#addScModal">
