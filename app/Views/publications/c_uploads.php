<section class="content-header">
  ...
  <ol class="breadcrumb">
    ...
    <li>Publications</li>
    <li class="active">Common Uploads</li>
  </ol>
</section>
       ...
       <div class="box-body table-responsive">
        <div class="datatable-fix">
            ...
            <i class="fa fa-eye"></i></a>
                            ...
                            <button class="btn btn-xs btn-primary edit-cu-btn"
    data-id="<?= $row['id'] ?>"
...
<?php endif; ?>
   ...
   <?php if($isAdmin || !empty($perms['can_delete'])): ?>
    <button class="btn btn-xs btn-danger delete-cu-btn"
    data-id="<?= $row['id'] ?>">
...
<?php endif; ?>
          ...
          <?php if($isAdmin || !empty($perms['can_add'])): ?>
            <button class="btn btn-xs btn-success" data-toggle="modal" data-target="#addCuModal">
